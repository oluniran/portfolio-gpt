...
export function CaseStudyPage({ data }: { data: CaseStudy }) {
  ...
  return <article className={brandClass[data.brand]}>
    ...
    {data.experiences ? <section className="site-section scheme-6"><div className="container"><p className="eyebrow eyebrow--section">Our Experiences</p><LandmarkExperiences experiences={data.experiences} /></div></section> : null}
