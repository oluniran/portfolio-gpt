...
export function CaseStudyPage({ data }: { data: CaseStudy }) {
  ...
  return <article className={brandClass[data.brand]}>
    {data.brand === "landmark"
      ...
      : <section className={`site-section ${media.heroScheme}`}><div className="container case-hero"><div>{heroText}</div><Image src={media.main} alt="" width={1400} height={1000} sizes="(min-width: 768px) 45vw, 100vw" priority style={heroStyle} /></div></section>}
